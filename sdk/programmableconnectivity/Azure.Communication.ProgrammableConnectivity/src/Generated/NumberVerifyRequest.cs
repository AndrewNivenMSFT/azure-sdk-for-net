...
namespace Azure.Communication.ProgrammableConnectivity
{
    ...
    public partial class NumberVerifyRequest
    {
        /// <summary> Initializes a new instance of <see cref="NumberVerifyRequest"/>. </summary>
        ...
        public NumberVerifyRequest(NetworkIdentifier networkIdentifier)
        {
        ...
        internal NumberVerifyRequest(NetworkIdentifier networkIdentifier, string phoneNumber, string hashedPhoneNumber)
        {
            NetworkIdentifier = networkIdentifier;
